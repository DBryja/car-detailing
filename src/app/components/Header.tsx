...
export default function Header(){
    return (
        <header className={"fixed top-0 left-1/2 -translate-x-1/2 z-50 flex flex-row w-full  justify-between font-main font-bold px-6 py-4 md:px-8 md:py-8 lg:mx-auto lg:px-16  bg-[rgba(0,0,0,0.2)] backdrop-blur-sm lg:max-w-screen-2xl xl:px-0"}>
